...
{	
    ...
    /******************************************************************************/
    // Codigo para la recepcion, comentado para no consumir tiempo
    /******************************************************************************/
	...
	*(tse + 2) = *(tse + 2) | 0x0000004B;	
    ...
    while (1) {
		...
		while (alt_avalon_sgdma_check_descriptor_status(&tx_descriptor) != 0)
		 	;
        //************************************************************
        // printf("a");   // Pongo este print para bajar un poco el ancho de banda de transmisión. 
